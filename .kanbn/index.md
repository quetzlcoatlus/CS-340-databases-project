...
- [write-project-overview](tasks/write-project-overview.md)
- [select-project-topic](tasks/select-project-topic.md)
- [draft-database-outline-in-words](tasks/draft-database-outline-in-words.md)
